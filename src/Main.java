...
public class Main {
    ...
    public void command() {
        ...
        while (true) {
            ...
            System.out.print("All available exits are ...");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Q for quit..." +
                ...
                "N for north..." +
                "W for west....");
        System.out.println("You can type a letter or word in any case and also Word containing that direction");
        System.out.println("you may have  a good adventure");
        Main main = new Main();
        main.command();
